...
{{- printf "%s-sim-storage" $prefix | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{/*
Create the name of etg client server
*/}}
{{- define "k8s-referencia.etgClient" -}}
{{- $prefix := default .Values.namePrefix "k8s" }}
{{- printf "%s-etg-job" $prefix | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- $prefix := default .Values.namePrefix "k8s" }}
{{- printf "%s-sim-job" $prefix | trunc 63 | trimSuffix "-" }}
{{- end }}
